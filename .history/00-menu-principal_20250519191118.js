...
// Lista de programas com formatação alinhada
const programas = [
...
function mostrarMenu() {
  ...
  rl.question('Digite o número do programa que deseja executar: ', (opcao) => {
    ...
    // Solução definitiva para restaurar o menu
    ...
    child.on('exit', (code) => {
      ...
      // Força a restauração do menu após 1 segundo
...
// Configuração global para Ctrl+C
process.on('SIGINT', () => {
